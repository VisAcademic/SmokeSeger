...
__all__ = [
    'SMixVisionTransformer',
    'SMixVisionTransformer_B1',
    'SMixVisionTransformer_B2',
    'SMixVisionTransformer_B3',
    'SMixVisionTransformer_B4',
    'SMixVisionTransformer_B5'
]
...
class SMixVisionTransformer(nn.Layer):
    def __init__(self,
                 img_size=(512, 512),
                 patch_size=16,
                 in_chans=3,
        ...
        self.block4 = nn.LayerList([
            Block(
                ...
                need_out_attn=need_out_attn) for i in range(depths[3])
        ])
...
def SMixVisionTransformer_B0(**kwargs):
    return SMixVisionTransformer(
        patch_size=4,
...
@manager.BACKBONES.add_component
def SMixVisionTransformer_B1(**kwargs):
    return SMixVisionTransformer(
        patch_size=4,
...
@manager.BACKBONES.add_component
def SMixVisionTransformer_B2(**kwargs):
    return SMixVisionTransformer(
        patch_size=4,
        embed_dims=[64, 128, 320, 512],
        num_heads=[1, 2, 5, 8],
...
@manager.BACKBONES.add_component
def SMixVisionTransformer_B3(**kwargs):
    return SMixVisionTransformer(
        patch_size=4,
        embed_dims=[64, 128, 320, 512],
        num_heads=[1, 2, 5, 8],
...
@manager.BACKBONES.add_component
def SMixVisionTransformer_B4(**kwargs):
    return SMixVisionTransformer(
        patch_size=4,
        embed_dims=[64, 128, 320, 512],
        num_heads=[1, 2, 5, 8],
...
@manager.BACKBONES.add_component
def SMixVisionTransformer_B5(**kwargs):
    return SMixVisionTransformer(
        patch_size=4,
        embed_dims=[64, 128, 320, 512],
        num_heads=[1, 2, 5, 8],
...
if __name__ == '__main__':
    network = SMixVisionTransformer_B2()
